  ...
  return (
    <div className="h-screen overflow-y-scroll py-4 shadow-xl flex flex-col ">
      ...
      <div className="functions px-10 font-semibold flex-col flex space-y-4 text-lg">
        ...
        {session.data?.user.admin.members == true && (
        ...
        {session.data?.user.admin.events == true && (
        ...
        {session.data?.user.admin.users == true && (
          <Link href={'/admin/users'}>
            ...
            >
              <div className={selected == 'users' ? 'text-gfg' : ''}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className={selected == 'users' ? 'text-gfg' : ''}>Users</div>
            </div>
          </Link>
        )}

        {session.data?.user.admin.superadmin == true && (
          <Link href={'/admin/power'}>
            ...
            >
              <div className={selected == 'power' ? 'text-gfg' : ''}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <div className={selected == 'power' ? 'text-gfg' : ''}>Power</div>
            </div>
          </Link>
        )}
        {session.data?.user.admin.contacts == true && (
          <Link href={'/admin/contacts'}>
            ...
            >
              <div className={selected == 'contacts' ? 'text-gfg' : ''}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        {session.data?.user.admin.bouncer == true && (
          <Link href={'/admin/bouncer'}>
            <div
              className={'flex flex-row space-x-2 items-center'}
              onClick={() => {
                setSelected('bouncer');
            ...
            >
              <div className={selected == 'bouncer' ? 'text-gfg' : ''}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
